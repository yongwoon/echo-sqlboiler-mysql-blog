...
func (o *GorpMigration) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to populate default values for gorp_migrations")
	}
...
func (o *GorpMigration) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to upsert for gorp_migrations")
	}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to retrieve unique values for gorp_migrations")
	}
