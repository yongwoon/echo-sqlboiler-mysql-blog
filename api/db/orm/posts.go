...
var PostWhere = struct {
	...
	ID:        whereHelperuint64{field: "`posts`.`id`"},
...
var (
	postAllColumns            = []string{"id", "title", "body", "created_at", "updated_at"}
	postColumnsWithoutDefault = []string{"id", "title", "body"}
...
func FindPost(ctx context.Context, exec boil.ContextExecutor, iD uint64, selectCols ...string) (*Post, error) {
	postObj := &Post{}
...
func (o *Post) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to populate default values for posts")
	}
...
func (o *Post) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to upsert for posts")
	}
	...
	if err != nil {
		return errors.Wrap(err, "orm: unable to retrieve unique values for posts")
	}
...
func PostExists(ctx context.Context, exec boil.ContextExecutor, iD uint64) (bool, error) {
	var exists bool
